...
extension Font {
    static func myFont(style: Font.TextStyle, weight: fontWeight? = nil) -> Font {
        ...
        case .light: fontName = "Quicksand-Light"
        case .regular: fontName = "Quicksand-Regular"
        case .medium: fontName = "Quicksand-Medium"
        case .semiBold: fontName = "Quicksand-SemiBold"
        case .bold: fontName = "Quicksand-Bold"
        }
